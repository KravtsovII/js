...
main_header.innerText = 'sept-2021-javascript';
...
ul[0].style.border = '1px solid red'; // це для тексту щоб було видно що міняється значення ширини

//    c) робить шириниу всіх елементів з класом linkList шириною 50%

let li = document.getElementsByClassName('linkList');
for (const liElement of li) {
    liElement.style.border = '1px solid red'; // це для тексту щоб було видно що міняється значення ширини
...
for (const liAllElement of liAll) {
    ...
    liAllElement.style.margin = '2px'; // це щоб було видно що фон працює для усіх елементів окремо
}
...
// }
// // напряму звертаючись до елементу
